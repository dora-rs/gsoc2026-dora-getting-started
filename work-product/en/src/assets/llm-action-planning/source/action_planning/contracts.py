...
PLAN_SCHEMA = "action_planning.action-plan.v1"
OBSERVATION_SCHEMA = "action_planning.switch-observation.v1"
SKILL_REQUEST_SCHEMA = "action_planning.skill-request.v1"
SKILL_RESULT_SCHEMA = "action_planning.skill-result.v1"
