...
Continue by choosing one extension, preserving the existing Dora data contracts, and adding a focused verification case before expanding the complete workflow.
