...
The work product is organized as a readable book plus the media assets directly
referenced by that book. Curated media live inside the matching language book
asset directories.
...
- Book media assets: `work-product/en/src/assets/` and `work-product/zh/src/assets/`
